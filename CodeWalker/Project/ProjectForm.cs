...
namespace CodeWalker.Project
{
    public partial class ProjectForm : Form
    {
        ...
        public ProjectForm(WorldForm worldForm = null)
        {
            ...
            this.Text = "SR File - Éditeur de Projet";
        ...
        public void NewProject()
        {
            ...
            CurrentProjectFile.Name = "New SR File Project";
        ...
        {
            string file = ShowOpenDialog("SR File Projects|*.cwproj", string.Empty);
        ...
        public void SaveProject(bool saveas = false)
        {
            ...
            {
                string fileName = ShowSaveDialog("SR File Projects|*.cwproj", CurrentProjectFile.Filepath);
        ...
        private bool DeleteYmapEntity()
        {
            ...
            {
                MessageBox.Show("This entity's numChildren is not 0 - deleting entities with children is not currently supported by SR File.");
                return true;
            }
            ...
            for (int i = idx + 1; i < CurrentYmapFile.AllEntities.Length; i++)
            {
                ...
                {
                    MessageBox.Show("There are other entities present in this .ymap that have children. Deleting this entity is not currently supported by SR File.");
                    return true;
                }
            }
        ...
        private void UpdateFormTitleText()
        {
            if (CurrentProjectFile == null)
            {
                Text = "Project - SR File";
            }
            else
            {
                Text = CurrentProjectFile.Name + " - SR File";
            }
        }
        ...
        private void ProjectForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (CurrentProjectFile?.HasChanged ?? false)
            {
                ...
                {
                    msg = "Are you sure you want to quit SR File?";
                    tit = "Confirm quit";
                }
