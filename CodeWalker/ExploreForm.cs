...
namespace CodeWalker
{
    public partial class ExploreForm : Form
    {
        ...
        public ExploreForm()
        {
            ...
            try
            {
                var appIcon = SRLogo.GetAppIcon();
                if (appIcon != null) this.Icon = appIcon;
            }
            catch { }

            this.Text = "SR File - RPF Explorer";
            ...
            try
            {
                SRThemeManager.RegisterForm(this, this.MainToolbar, () =>
                {
                    ...
                    MainTreeView.ForeColor = SRThemeManager.Text;
                    MainTreeView.LineColor = SRThemeManager.SubText;
                    MainListView.BackColor = SRThemeManager.InputBackground;
                    MainListView.ForeColor = SRThemeManager.Text;
                    LocationTextBox.BackColor = SRThemeManager.InputBackground;
                    LocationTextBox.ForeColor = SRThemeManager.Text;
                    SearchTextBox.BackColor = SRThemeManager.InputBackground;
                    SearchTextBox.ForeColor = SRThemeManager.Text;
                    MainMenu.Renderer = new SRToolStripRenderer();
                    MainToolbar.Renderer = new SRToolStripRenderer();
                    MainStatusBar.Renderer = new SRToolStripRenderer();
                    MainMenu.BackColor = SRThemeManager.Surface;
                    MainToolbar.BackColor = SRThemeManager.Surface;
                    MainStatusBar.BackColor = SRThemeManager.Surface;
                    SRThemeManager.ApplyToContextMenu(ListContextMenu);
                    SRThemeManager.ApplyToContextMenu(TreeContextMenu);
                });
            }
            catch { }
        }
        ...
        private void SetTheme(string themestr, bool changing = true)
        {
            ...
            switch (themestr)
            {
                ...
                case "Blue":
                    ...
                    if (changing) SRThemeManager.Preset = SRThemePreset.DarkSlate;
                    break;
                case "Light":
                    Theme = new VS2015LightTheme();
                    ViewThemeLightMenu.Checked = true;
                    if (changing) SRThemeManager.Preset = SRThemePreset.LightModern;
                    break;
                case "Dark":
                    Theme = new VS2015DarkTheme();
                    ViewThemeDarkMenu.Checked = true;
                    if (changing) SRThemeManager.Preset = SRThemePreset.SRCrimson;
                    break;
            }
        ...
        public void ConfigureGame()
        {
            ...
            if (result)
            {
                MessageBox.Show("Please restart SR File to use the new folder.");
            }
        }
        ...
        private void DefragmentSelected()
        {
            ...
            Form form = new Form() {
                ...
                Text = "Defragment RPF Archive - SR File",
