...
namespace CodeWalker
{
    public partial class WorldForm : Form, DXForm
    {
        ...
        private void Init()
        {
            ...
            LocatorIcon = Icons.Count > 2 ? Icons[2] : (Icons.Count > 0 ? Icons[0] : null);
        ...
        public bool ConfirmQuit()
        {
            ...
            {
                if (MessageBox.Show("Are you sure you want to quit SR File?", "Confirm quit", MessageBoxButtons.YesNo) != DialogResult.Yes)
                {
                    return false;
                }
            }
        ...
        private void ContentThread()
        {
            ...
            {
                MessageBox.Show("Keys not found! This shouldn't happen, GTA5.exe outdated? SR File outdated?");
                Close();
                return;
            }
        ...
        private void ResetSettings()
        {
            ...
            MessageBox.Show("All settings have been reset to their default values. Please restart SR File.");
        }
